...
class Client(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, addr):
        if addr == self.server:
            ...
            print(addr, ":", datagram)
            print(datagram)
            if datagram.startswith("Wyślij") == False:
    ...
    def send_message(self):
        while True:
            ...
            if msg.startswith("[Send block]"):
                ...
                blok_do_wyslania ='$' + str(blockchain2[-2].to_json())
                port = int(input('Podaj port wezla'))
...
bG2 = Block(index=0, previous_hash= '5vh21v85232v0P1v08g5081vhh023n2b085', hash = None,
